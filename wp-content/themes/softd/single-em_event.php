...
get_template_part( 'includes/header' , 'page-title' ); ?>
			...
			<!-- BLOG AREA START -->
			<div class="softd-blog-area softd-event-singlea softd-blog-single em-single-page-comment single-blog-details">
				<div class="container">				
					<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-12  col-sm-12 col-xs-12 blog-lr">
								...
								$map_event  = get_post_meta( get_the_ID(),'_softd_map_event', true ); 
								?>
								...
								<div class="softd-single-blog-details">
									<?php if(has_post_thumbnail()){?>
										<div class="softd-single-blog--thumb">
											<?php the_post_thumbnail('softd-event-single'); ?>
										</div>									
									<?php } ?>
									...
									<div class="single_event_content">
										...
										<?php if($event_time || $event_address){?>
											<div class="softd-event-meta-left_adn esi">
							...
							<div class="col-md-12">
								<div class="event-description">
									...
									<?php $event_titles  = get_post_meta( get_the_ID(),'_softd_event_titles', true ); ?>
									<?php if($event_titles){?>  
									...
									<div class="event-dsc-info">
										<ul>
											...
											<?php 
											$eventgroup  = get_post_meta( get_the_ID(),'_softd_eventgroup', true ); 
											
											if( $eventgroup ){?>
												<?php
												foreach ( (array) $eventgroup as $daygropd => $daygropss ){
												$day1 = $day2 ='';
												if ( isset( $daygropss['_softd_etime1'] ) ) {
													$day1 =  $daygropss['_softd_etime1'];	
												}	
												if ( isset( $daygropss['_softd_etime2'] ) ) {
													$day2 =  $daygropss['_softd_etime2'];	
												}?>
		...
		<div class="related-projects-area">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<h2 class="related-projects-title text-left"><?php esc_html_e('RELATED EVENTS', 'softd') ?></h2>
				</div>
