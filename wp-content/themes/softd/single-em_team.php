					...
					<div class="row ">
						...
						<?php if( have_posts() ) : ?>
							...
							<?php while( have_posts() ) : the_post();
								...
								$team_Info  = get_post_meta( get_the_ID(),'_softd_team_Info', true );
								$single_list  = get_post_meta( get_the_ID(),'_softd_single_list', true );
								$team_btn  = get_post_meta( get_the_ID(),'_softd_team_btn', true );
								$team_btnutl  = get_post_meta( get_the_ID(),'_softd_team_btnutl', true );
							?>					
