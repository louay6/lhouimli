...
// Register and load the widget
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'The most recent Review on your site.', 'softd' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'em_recent_Review_widget', esc_html__( 'EM Recent Review','softd' ), $widget_ops );
