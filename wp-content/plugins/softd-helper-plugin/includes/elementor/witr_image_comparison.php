...
class Witr_Elementor_Widget_Image_Comp extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WITR Image Comparison', 'softd' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Image Comparison', 'softd' ),
            ]
        );
            ...
            $this->add_control(
                'witr_before_image',
                [
                    'label' => esc_html__( 'Before Image', 'softd' ),
            ...
            $this->add_control(
                'witr_after_image',
                [
                    'label' => esc_html__( 'After Image', 'softd' ),
                    'type' => Controls_Manager::MEDIA,
                    'default' => [
                        'url' => Utils::get_placeholder_image_src(),
                    ],
            ...
            $this->add_control(
                'witr_before_title',
                [
                    'label' => esc_html__( 'Before Title', 'softd' ),
                    'type' => Controls_Manager::TEXT,
                    'placeholder'=>esc_html__('Before','softd'),
                ]
            );
            ...
            $this->add_control(
                'witr_after_title',
                [
                    'label' => esc_html__( 'After Title', 'softd' ),
                    'type' => Controls_Manager::TEXT,
                    'placeholder'=>esc_html__('After','softd'),
                ]
            );
            ...
            $this->add_control(
                'witr_start_amount',
                [
                    'label' => esc_html__( 'Before Start Amount', 'softd' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Label Position', 'softd' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'top',
                    'options' => [
                        'top'      => esc_html__( 'Top', 'softd' ),
                        'center'   => esc_html__( 'Center', 'softd' ),
                        'bottom'   => esc_html__( 'Bottom', 'softd' ),
                    ],
                ]
            );
			/* witr_unicid_c */	
			$this->add_control(
				...
				[
					...
					'description' => esc_html__( 'Please use a unic ID here, ex- witr_1. Not use 0', 'softd' ),
					'default' => 'witrb_1',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Handler', 'softd' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Image After', 'softd' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Witr_Elementor_Widget_Image_Comp() );
