...
class Witr_Theme_Section_Modal extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WITR: Modal', 'softd' );
    }
    ...
    protected function register_controls() {
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'witr Modal Options', 'softd' ),
					...
					$repeater->add_control(
						'witr_show_menu',
						[
							'label' => esc_html__( 'Show Menu Title', 'softd' ),
							'type' => Controls_Manager::SWITCHER,
							'separator'=>'before',
							'label_on' => esc_html__( 'Show', 'softd' ),
							'label_off' => esc_html__( 'Hide', 'softd' ),
					...
					$repeater->add_control(
						'witr_modal_menu_t',
						[
							'label' => esc_html__( 'Menu Title', 'softd' ),
							'type' => Controls_Manager::TEXTAREA,
							'description' => esc_html__( 'Not use menu title, remove the text from field', 'softd' ),
							'default' => esc_html__( 'Enter Your menu Title', 'softd' ),
							'separator'=>'before',
							'placeholder' => esc_attr__( 'Type your menu title here', 'softd' ),
							'condition' => [
								'witr_show_menu' => 'yes',
							],							
						]
					...
					$repeater->add_control(
						'witr_modal_title',
						[
							'label' => esc_html__('Modal Title', 'softd' ),
							'type' => Controls_Manager::TEXTAREA,
				...
				$repeater->add_control(
					'witr_modal_lists',
					[
						'label' => esc_html__( 'Modal List Items ', 'softd' ),
						'type' => Controls_Manager::TEXTAREA,
						'separator' => 'before',
					...
					$repeater->add_control(
						...
						[
							...
							'type' => Controls_Manager::TEXTAREA,
							'description' => esc_html__( 'Please use a unic or different ID here, ex- wittr_1.', 'softd' ),
					...
					$this->add_control(
						...
						[
							...
							'default' => [
								[
									'witr_modal_title' => esc_html__( 'Add your Title', 'softd' ),
	   ...
	   /*============================================================================================================================================================
		...
		=============================================================================================*/
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'witr Section Position Options', 'softd' ),
				...
				$this->start_controls_tabs( 'modal' );
					...
					$this->start_controls_tab(
						...
						$this->add_responsive_control(
							'witr_1_top',
							[
								'label' => esc_html__( 'Section Top', 'softd' ),
						...
						$this->add_responsive_control(
							'witr_1_left',
							[
								'label' => esc_html__( 'Section Left', 'softd' ),
								'type' => Controls_Manager::SLIDER,
								'size_units' => [ 'px', '%' ],
								'range' => [
									'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Menu Color Option', 'softd' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);		 
			/* color */
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'All Text And Hover Color', 'softd' ),
				'tab' => Controls_Manager::TAB_STYLE,					
			]
		);		 
			/* color */
					...
					foreach($witrshowdata['witr_list_cslide'] as $witr_single_modal){?>		
							...
							<div class="witr_modal_box all_modal_color">
								<div class="witr_modal_menu">
									...
									<!-- custom icon -->
									<?php if(isset($witr_single_modal['witr_modal_custom']) && ! empty($witr_single_modal['witr_modal_custom'])){?>					
...
Plugin::instance()->widgets_manager->register_widget_type( new Witr_Theme_Section_Modal() );
