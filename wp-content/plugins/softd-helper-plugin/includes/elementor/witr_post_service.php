...
class Witr_Elementor_Widget_Service extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WITR : Post Service', 'softd' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'6' => esc_html__( '3D/flip Style', 'softd' ),
						...
						'12' => esc_html__( 'Image Set Must Be style 12', 'softd' ),						
					],
					'default' => '1',
				]
			);
            ...
            $this->add_control(
                'witr_post_per_page',
                [
                    'label' => __( 'Show Number Of service', 'softd' ),
			...
			/* service show witr_adc_service */
 			$this->add_control(
				'witr_adc_service',
				[
					'label' => esc_html__( 'service ASC/DSC style', 'softd' ),
					'type' => Controls_Manager::SELECT,
                    'separator' => 'before',					
					'options' => [
			...
			/* service button witr_filter_button 		
            $this->add_control(
                'witr_filter_button',
                [
	   ...
	   /*===============================================================================================================================
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Text Box Color Option', 'softd' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
...
/* =================================================== Bekend Option =================================================================== */
    ...
    protected function render( $instance = [] ) {
		...
		switch( $witrshowdata['witr_style_service']){
			...
			?>
				<div class="service_active">				
					<div class=" witr_cars12_<?php echo $unic_id;?>">				
						<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
							$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
							$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
							$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
							$service_i_image  = get_post_meta( get_the_ID(),'_softd_img_s', true ); 
							$show_list  = get_post_meta( get_the_ID(),'_softd_show_list', true ); 
							$list_text  = get_post_meta( get_the_ID(),'_softd_list_text', true ); 
							$subtitle  = get_post_meta( get_the_ID(),'_softd_subtitle', true ); 
						?>
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars12_<?php echo $unic_id;?>').slick({
			...
			?>
				<div class="service_active">				
					<div class=" witr_cars11_<?php echo $unic_id;?>">				
						<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
							$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
							$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
							$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars11_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
			...
			?>
				<div class="service_active">				
				<div class=" witr_cars10_<?php echo $unic_id;?>">				
					<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
						$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
						$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
						$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars10_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
			...
			?>
				<div class="service_active">				
				<div class=" witr_cars9_<?php echo $unic_id;?>">				
					<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
						$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
						$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
						$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars9_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
			...
			?>
				<div class="service_active">				
				<div class=" witr_cars8_<?php echo $unic_id;?>">				
					<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
						$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
						$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
						$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars8_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
			...
			?>
				<div class="service_active">				
				<div class=" witr_cars7_<?php echo $unic_id;?>">				
					<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
						$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
						$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
						$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars7_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
			...
			?>
				...
				<div class=" witr_cars6_<?php echo $unic_id;?>">				
					<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
						$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
						$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
						$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars6_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
			...
			?>
				...
				<div class="service_active">				
				<div class=" witr_cars5_<?php echo $unic_id;?>">				
					<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
						$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
						$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
						$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars5_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
			...
			?>
				<div class="service_active">				
				<div class=" witr_cars4_<?php echo $unic_id;?>">				
					<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
						$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
						$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
						$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars4_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
			...
			?>
				<div class="service_active">				
				<div class=" witr_cars3_<?php echo $unic_id;?>">				
					<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
						$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
						$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
						$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars3_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
        ...
        ?>
				...
				<div class="service_active">				
				<div class=" witr_cars2_<?php echo $unic_id;?>">				
					<?php while ($the_query->have_posts()) : $the_query->the_post(); 						
						$service_icon  = get_post_meta( get_the_ID(),'_softd_service_icon', true );
						$icon_text  = get_post_meta( get_the_ID(),'_softd_icon_text', true ); 
						$service_img_show  = get_post_meta( get_the_ID(),'_softd_service_icon_img', true ); 
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars2_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
        ...
        ?>
				...
				<div class="service_active">
				<div class=" witr_cars1_<?php echo $unic_id;?>">
			...
			<script type='text/javascript'>
				jQuery(function($){
					...
					$('.witr_cars1_<?php echo $unic_id;?>').slick({
						infinite: <?php echo $infinite;?>,
						autoplay: <?php echo $autoplay;?>,
						autoplaySpeed: <?php echo $autoplayspeed;?>,
						speed: <?php echo $speed;?>,					
...
Plugin::instance()->widgets_manager->register_widget_type( new Witr_Elementor_Widget_Service() );
