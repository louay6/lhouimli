...
class Witr_Elementor_Widget_Event extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WITR : Post Event', 'softd' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'witr_event_option',
            [
                'label' => esc_html__( 'witr event options', 'softd' ),
            ]
        );
			...
			$this->add_control(
				'witr_style_event',
				[
					'label' => esc_html__( 'Event style', 'softd' ),
					'type' => Controls_Manager::SELECT,
					'options' => [
						'1' => esc_html__( 'Event style 1', 'softd' ),
						'2' => esc_html__( 'Event Carousel style 2', 'softd' ),
						'3' => esc_html__( 'Event Carousel style 3', 'softd' ),
						'4' => esc_html__( 'Event style 4', 'softd' ),
						'5' => esc_html__( 'Event style 5', 'softd' ),						
						'6' => esc_html__( 'Event Carousel style 6', 'softd' ),						
						'7' => esc_html__( 'Event style 7', 'softd' ),						
						'8' => esc_html__( 'Event Carousel style 8', 'softd' ),						
					],
					'default' => '1',
				]
			);
            ...
            $this->add_control(
                'witr_post_per_page',
                [
                    'label' => __( 'Show Number Of Posts Event', 'softd' ),
			...
			/* event show witr_adc_event */
 			$this->add_control(
				'witr_adc_event',
				[
					'label' => esc_html__( 'Event ASC/DSC style', 'softd' ),
					'type' => Controls_Manager::SELECT,
                    'separator' => 'before',					
					'options' => [
			...
			$this->add_control(
				'witr_show_time',
				[
					'label' => esc_html__( 'Show Date', 'softd' ),
					'type' => Controls_Manager::SWITCHER,
					'separator' => 'before',
					'label_on' => esc_html__( 'Show', 'softd' ),
					'label_off' => esc_html__( 'Hide', 'softd' ),
			...
			$this->add_control(
				'witr_show_address',
				[
					'label' => esc_html__( 'Show Address', 'softd' ),
					'type' => Controls_Manager::SWITCHER,
					'separator' => 'before',
					'label_on' => esc_html__( 'Show', 'softd' ),
					'label_off' => esc_html__( 'Hide', 'softd' ),
			...
			$this->add_control(
				'witr_show_year',
				[
					'label' => esc_html__( 'Show Year', 'softd' ),
					'type' => Controls_Manager::SWITCHER,
					'separator' => 'before',
					'label_on' => esc_html__( 'Show', 'softd' ),
					'label_off' => esc_html__( 'Hide', 'softd' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'separator' => 'before',					
					'description' => esc_html__( 'Not use button, remove the text from field', 'softd' ),
	   ...
	   /*===========================================================================================
		...
		=============================================================================================*/		
			...
			$this->start_controls_section(
				'witr_single_event',
				[
					'label' => esc_html__( 'Single Event Option', 'softd' ),
					...
					'condition' => [
						...
						$this->add_control(
							...
							[
								...
								'default' => 'default',
								'selectors' => [
									'{{WRAPPER}} .em-event-content-area_adn,{{WRAPPER}} .witr_event_style_5.softd-single-event_adn' => 'border-style: {{VALUE}}',
								],
							]
						);		
						/* witr_borde_box */
						$this->add_control(
							...
							[
								...
								'selectors' => [
									'{{WRAPPER}} .em-event-content-area_adn,{{WRAPPER}} .witr_event_style_5.softd-single-event_adn' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
								],
								'condition' => [
						...
						$this->add_control(
							...
							[
								...
								'selectors' => [
									'{{WRAPPER}} .em-event-content-area_adn,{{WRAPPER}} .witr_event_style_5.softd-single-event_adn' => 'border-color: {{VALUE}}',
								],
								'condition' => [
									'witr_border_box_style' => ['solid','double','dotted','dashed','default'],
								],								
				...
				$this->add_control(
					...
					[
						...
						'size_units' => [ 'px', '%' ],
						'selectors' => [
							'{{WRAPPER}} .em-event-content-area_adn,{{WRAPPER}} .witr_event_style_5.softd-single-event_adn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_group_control(
					...
					[
						...
						'label' => esc_html__( ' Event BG', 'softd' ),
						'types' => [ 'classic', 'gradient'],
						'selector' => '{{WRAPPER}} .softd-single-event_adn,{{WRAPPER}} .witr_event_style_5.softd-single-event_adn',
					]
				);
				...
				$this->add_group_control(
					...
					[
						...
						'label' => esc_html__( 'Event Shadow', 'softd' ),
						'selector' => '{{WRAPPER}} .softd-single-event_adn,{{WRAPPER}} .witr_event_style_5.softd-single-event_adn',
					]
				);
				/* Event Shadow Hover */				
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Event Shadow Hover', 'softd' ),
				...
				$this->add_group_control(
					...
					[
						...
						'label' => esc_html__( 'event Shadow Hover', 'softd' ),
						'selector' => '{{WRAPPER}} .softd-single-event_adn:hover,{{WRAPPER}} .witr_event_style_5.softd-single-event_adn:hover',
					]
				);
				/* witr_box_margin */
				$this->add_responsive_control(
					...
					[
						...
						'size_units' => [ 'px', '%', 'em' ],
						'selectors' => [
							'{{WRAPPER}} .em-event-content-area_adn,{{WRAPPER}} .witr_event_style_5.softd-single-event_adn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
				/* witr_box_padding */
				$this->add_responsive_control(
					...
					[
						...
						'size_units' => [ 'px', '%', 'em' ],
						'selectors' => [
							'{{WRAPPER}} .em-event-content-area_adn,{{WRAPPER}} .witr_event_style_5.softd-single-event_adn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Day, Month, Year Option', 'softd' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
				...
				$this->add_control(
					...
					[
						...
						'default' => '',
						'selectors' => [
							'{{WRAPPER}} .event_date span,{{WRAPPER}} .event_date_5 span,{{WRAPPER}} .softd_event_date span' => 'color: {{VALUE}}',
						],
				...
				$this->add_group_control(
					...
					[
						...
						'types' => [ 'classic', 'gradient'],					
						'selector' => '{{WRAPPER}} .event_date,{{WRAPPER}} .event_date_5,{{WRAPPER}} .softd_event_date',
					]
				);				
				/* typograohy color */			
				$this->add_group_control(
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .event_date span,{{WRAPPER}} .event_date_5 span,{{WRAPPER}} .softd_event_date span' => 'line-height: {{SIZE}}{{UNIT}};',
						],
					]
				);				
				...
				$this->add_responsive_control(
					'witr_dmy_dis_height',
					[
						'label' => esc_html__( 'Display', 'softd' ),
						'type' => Controls_Manager::TEXT,
						'description' => esc_html__( ' Use Field,  Ex:: display: inline-block;', 'softd' ),
						'placeholder' => esc_attr__( 'display: inline-block;', 'softd' ),						
						'selectors' => [
							'{{WRAPPER}} .event_date span,{{WRAPPER}} .event_date_5 span,{{WRAPPER}} .softd_event_date span' => 'display: {{SIZE}}{{UNIT}};',
						],
					]
				);				
				/* border_radius */
				$this->add_control(
					...
					[
						...
						'size_units' => [ 'px', '%' ],
						'selectors' => [
							'{{WRAPPER}} .event_date,{{WRAPPER}} .event_date_5,{{WRAPPER}} .softd_event_date' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
				/*  Rotate */
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .event_date,{{WRAPPER}} .event_date_5,{{WRAPPER}} .softd_event_date' => 'transform: rotate({{SIZE}}{{UNIT}});',
						],
					]
				);
				/*  Day-Month-Year */
				$this->add_responsive_control(
					'witr_dmy_opacity',
					[
						'label' => esc_html__( 'Day, Month, Year Opacity', 'softd' ),
						'type' => Controls_Manager::TEXT,
						'selectors' => [
							'{{WRAPPER}} .event_date,{{WRAPPER}} .event_date_5,{{WRAPPER}} .softd_event_date' => 'opacity: {{SIZE}}{{UNIT}};',
						],
					]
				);				
			/* witr_top */
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .event_date,{{WRAPPER}} .event_date_5,{{WRAPPER}} .softd_event_date' => 'top: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .event_date,{{WRAPPER}} .event_date_5,{{WRAPPER}} .softd_event_date' => 'left: {{SIZE}}{{UNIT}};',
					],
				]
			);				
			/*  margin */
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .event_date,{{WRAPPER}} .event_date_5,{{WRAPPER}} .softd_event_date' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			/* title padding */
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .event_date,{{WRAPPER}} .event_date_5,{{WRAPPER}} .softd_event_date' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);				
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Address Color Option', 'softd' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);		 
		...
		/*=== end  witr_title style ====*/	
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Top Icon Color Option', 'softd' ),
					'tab' => Controls_Manager::TAB_STYLE,
					'condition' => [
		...
		/*=== end  witr content style ====*/
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Admin Box Color Option', 'softd' ),
					'tab' => Controls_Manager::TAB_STYLE,
					'condition' => [
				...
				$this->start_controls_tabs( 'admin_colors' );
					...
					/*=== end admin normal style ====*/
						...
						$this->start_controls_tab(
							...
							[
								'label' => esc_html__( 'Degignation', 'softd' ),
							]
						);
							/* color */
							$this->add_control(
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( ' Background', 'softd' ),
					'types' => ['classic','gradient'],
					'selector' => '{{WRAPPER}} .event-img::before,{{WRAPPER}} .softd-event-thumb_adn:before',
				]
			);
			/* border_radius */
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', '%' ],
					'selectors' => [
						'{{WRAPPER}} .softd-event-thumb_adn,{{WRAPPER}} .softd-event-thumb_adn:before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
				...
				$this->start_controls_tabs( 'arrow_colors' );
					...
					$this->start_controls_tab(
						...
						$this->add_control(
							'witr_a_tb',
							[
								'label' => esc_html__( 'Select one time 2 style ex- top & left, If you need', 'softd' ),
								'type' => Controls_Manager::HEADING,
								'separator' => 'before',
							]
						);						
    ...
    protected function render( $instance = [] ) {
		...
		switch( $witrshowdata['witr_style_event']){
			...
			<div class="event_active event_style_adn_3 witr_3e event_all_color text-<?php echo $witrshowdata['witr_text_ltc']; ?>">				
				<div class=" event8_<?php echo $unic_id;?>">
					...
					?>
						<!-- single event -->
							<div class="col-lg-12 col-md-12 col-sm-12">
									...
									$event_year  = get_post_meta( get_the_ID(),'_softd_event_year', true );
									$admin_title  = get_post_meta( get_the_ID(),'_softd_admin_title', true );
									$admin_deg  = get_post_meta( get_the_ID(),'_softd_admin_deg', true );
									$admin_img  = get_post_meta( get_the_ID(),'_softd_admin_img', true );
									?>
									<div class="row softd-single-event_adn witr_event_style_5 witr_event_style_7 witr_event_style_8">
									<div class="event_display_flex">
										<div class="witr_image_event">
											<!-- BLOG THUMB -->
											<?php if(has_post_thumbnail()){?>
												<div class="softd-event-thumb_adn">
													<a href="<?php the_permalink(); ?>"> <?php the_post_thumbnail('softd-event-default'); ?></a>
										...
										<div class="wite_event_box">
											...
											<div class="event-page-title_adn ">
												...
												<?php if( $event_address || $event_time){?>
													<div class="softd-event-meta-left_adn span_text">
														<?php if($witrshowdata['witr_show_time']=='yes'){?>
															<?php if($event_time){?>
																<span><i class="fa fa-clock-o"></i><?php if($event_time){ echo esc_html($event_time);}?></span>
															<?php }?>
														<?php }?>
														...
														<?php if($witrshowdata['witr_show_year']=='yes'){?>
															...
															<?php if($event_day || $event_month ||$event_year){?>
																<span><i class="fas fa-calendar-alt"></i><?php if($event_day){ echo esc_html($event_day);}?> <?php if($event_month){ echo esc_html($event_month);}?> <?php if($event_year){ echo esc_html($event_year);}?></span>
															<?php } ?>
		...
		<script type='text/javascript'>
			jQuery(function($){
				...
				$('.event8_<?php echo $unic_id;?>').slick({
					...
					?>
						<!-- single event -->
							<div class="col-lg-12 col-md-12 col-sm-12  <?php echo $witr_gutter_column; ?>">
									...
									$admin_img  = get_post_meta( get_the_ID(),'_softd_admin_img', true );
									?>
									<div class="row softd-single-event_adn witr_event_style_5 witr_event_style_7">
			...
			?>
                <div class=" event_active event_all_color text-<?php echo $witrshowdata['witr_text_ltc']; ?>">	
					<div class="witr_event_6 event6_<?php echo $unic_id;?>">
						<?php
						...
						?>
							<div class="col-lg-12 col-md-6 col-sm-12  <?php echo $witr_gutter_column; ?>">
								...
								?>
								<div class="softd-single-event_adns">					
									<!-- BLOG THUMB -->
									<?php if(has_post_thumbnail()){?>
										<div class="softd-event-thumb_adn">
											<?php the_post_thumbnail('softd-event-370-450'); ?>												
											<div class="softd_event_abs">
												<?php if($event_day || $event_month || $event_year){?>
													<div class="softd_event_date">
												...
												<?php if($event_time || $event_address){?>
													<div class="softd-event-meta-left_adn">
														<?php if($witrshowdata['witr_show_time']=='yes'){?>
															<?php if($event_time){?>
		...
		<script type='text/javascript'>
			jQuery(function($){
				...
				$('.event6_<?php echo $unic_id;?>').slick({
					infinite: <?php echo $infinite;?>,
					autoplay: <?php echo $autoplay;?>,
					autoplaySpeed: <?php echo $autoplayspeed;?>,
					speed: <?php echo $speed;?>,					
					...
					?>
						<!-- single event -->
							<div class="col-lg-12 col-md-12 col-sm-12  <?php echo $witr_gutter_column; ?>">
									...
									$event_year  = get_post_meta( get_the_ID(),'_softd_event_year', true );
									?>
									<div class="row softd-single-event_adn witr_event_style_5">
											...
											<div class="witr_event_d">
												<?php if($event_day || $event_month || $event_year){?>
													<div class="event_date_5">
														<span><i class="fas fa-calendar"></i><?php if($event_day){ echo esc_html($event_day);}?></span>
														<span><?php if($event_month){ echo esc_html($event_month);}?></span>
														<?php if($witrshowdata['witr_show_year']=='yes'){?>
															<span><?php if($event_year){ echo esc_html($event_year);}?></span>
														<?php } ?>
						...
						?>
							<div class="col-lg-<?php if( !empty( $witrshowdata['witr_column_grid'] ) ){echo $witrshowdata['witr_column_grid'];}?>  col-md-6 col-sm-8 mrbe20  <?php echo $witr_gutter_column; ?>">
								...
								<div class="softd-single-event_adns">					
									...
									<?php if(has_post_thumbnail()){?>
										<div class="softd-event-thumb_adn">
											<?php the_post_thumbnail('softd-event-default'); ?>												
										<div class="witr_category"><div class="tevbt"><?php esc_html_e('Event','softd');?></div></div>
											<div class="softd_event_abs">
												<?php if($event_day || $event_month || $event_year){?>
													<div class="softd_event_date">
														<span><?php if($event_day){ echo esc_html($event_day);}?></span>
			...
			<div class="event_active event_style_adn_3 witr_3e margin_top0 event_all_color text-<?php echo $witrshowdata['witr_text_ltc']; ?>">				
				<div class="event_wrap event_carousel event_<?php echo $unic_id;?>">
					...
					?>
						<!-- single event -->
							<div class="col-lg-12 col-md-6 col-sm-12  <?php echo $witr_gutter_column; ?>">
									...
									$event_year  = get_post_meta( get_the_ID(),'_softd_event_year', true );
									?>
									<div class="softd-single-event_adn">					

									<!-- BLOG THUMB -->
									<?php if(has_post_thumbnail()){?>
										<div class="softd-event-thumb_adn">
											<?php the_post_thumbnail('softd-event-default'); ?>
											<div class="witr_icon_adn"><a href="<?php the_permalink(); ?>"> <i class="fas fa-link"></i></a></div>
											<?php if($event_day || $event_month || $event_year){?>
		...
		<script type='text/javascript'>
			...
			?>
				<div class="event_active witr_2e event_all_color text-<?php echo $witrshowdata['witr_text_ltc']; ?>">
					<div class="event2_<?php echo $unic_id;?>">
						<?php
						...
						?>
							...
							<div class="col-lg-12 col-md-6 col-sm-12  <?php echo $witr_gutter_column; ?>">
								<?php
								$event_time  = get_post_meta( get_the_ID(),'_softd_event_time', true ); 
								$event_address  = get_post_meta( get_the_ID(),'_softd_event_address', true ); 
								$event_day  = get_post_meta( get_the_ID(),'_softd_event_day', true ); 
								$event_month  = get_post_meta( get_the_ID(),'_softd_event_month', true );
								$event_year  = get_post_meta( get_the_ID(),'_softd_event_year', true );
		...
		<script type='text/javascript'>
			jQuery(function($){
				...
				$('.event2_<?php echo $unic_id;?>').slick({
					infinite: <?php echo $infinite;?>,
					autoplay: <?php echo $autoplay;?>,
					autoplaySpeed: <?php echo $autoplayspeed;?>,
					speed: <?php echo $speed;?>,					
...
Plugin::instance()->widgets_manager->register_widget_type( new Witr_Elementor_Widget_Event() );
