...
class Witr_Theme_Section_Screenshort extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WITR: Carousel Screenshorts', 'softd' );
    }
    ...
    protected function register_controls() {
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'witr Carousel Screenshorts Options', 'softd' ),
				...
				$this->add_control(
					'witr_style_screen',
					[
						'label' => esc_html__( 'Screenshorts style', 'softd' ),
						'type' => Controls_Manager::SELECT,
						'separator' => 'before',
						'options' => [
							'1' => esc_html__( 'Slider Center Mode style', 'softd' ),
							'2' => esc_html__( 'Slider LightBox style', 'softd' ),
							'3' => esc_html__( 'Slider Frame style', 'softd' ),
							'4' => esc_html__( 'DnSlide Slider style', 'softd' ),
						],
						'default' => '1',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'separator'=>'before',
						'default' => [],
						'description' =>esc_html__( 'Add Screenshorts Images', 'softd' ),
						'show_label' => false,
						'dynamic' => [
							'active' => true,
						],
				...
				$this->add_control(
					...
					[
						...
						'separator' => 'before',
						'default' => [],
						'description' =>esc_html__( 'Add Screenshorts Images, size - 529x333px and set imgage 8 item', 'softd' ),
						'show_label' => false,
						'dynamic' => [
							'active' => true,
						],
				...
				/* witr_show_image witr_screen_image */
					$this->add_control(
						'witr_show_image',
						[
							'label' => esc_html__( 'Show Body Image', 'softd' ),
					...
					$this->add_control(
						...
						[
							...
							'separator' => 'before',
							'description' => esc_html__( ' use to Choose Image for frame png Image must be.', 'softd' ),
							'default' => [
								'url' =>'',
							],
							'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Witr_Theme_Section_Screenshort() );
