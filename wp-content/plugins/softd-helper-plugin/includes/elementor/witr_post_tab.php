...
class Witr_Elementor_Widget_Posttab extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WITR : Post Tab', 'softd' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'witr_tab_option',
            [
                'label' => esc_html__( 'witr tab options', 'softd' ),
            ]
        );
			...
			$this->add_control(
				'witr_style_tab',
				[
					'label' => esc_html__( 'Tab style', 'softd' ),
					'type' => Controls_Manager::SELECT,
					'options' => [
						'1' => esc_html__( 'Tab style 1', 'softd' ),
						'2' => esc_html__( 'Tab style 2', 'softd' ),
						'3' => esc_html__( 'Tab style 3', 'softd' ),
					],
					'default' => '1',
				]
			);
            ...
            $this->add_control(
                'witr_post_per_page',
                [
                    'label' => __( 'Show Number Of tab', 'softd' ),
			...
			/* tab show witr_adc_tab */
 			$this->add_control(
				'witr_adc_tab',
				[
					'label' => esc_html__( 'Tab ASC/DSC style', 'softd' ),
					'type' => Controls_Manager::SELECT,
                    'separator' => 'before',					
					'options' => [
	   ...
	   /*===========================================================================================
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Menu Option', 'softd' ),
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Tab Menu Color', 'softd' ),
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Tab Menu Hover Color', 'softd' ),
						'type' => Controls_Manager::COLOR,
						'global' => [
				...
				$this->add_responsive_control(
					'witr_menu_size',
					[
						'label' => esc_html__( 'Tab Menu Size', 'softd' ),
				...
				$this->add_responsive_control(
					'witr_menu_margin',
					[
						'label' => esc_html__( 'Menu Margin', 'softd' ),
				...
				$this->add_responsive_control(
					'witr_menu_padding',
					[
						'label' => esc_html__( 'Menu Padding', 'softd' ),
						'type' => Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', '%', 'em' ],
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Tab Menu Active Color', 'softd' ),
						'type' => Controls_Manager::COLOR,
						'separator'=>'before',						
						'selectors' => [
				...
				$this->add_control(
					'witr_active_border_style',
					[
						'label' => esc_html__( 'Active Border Style', 'softd' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
				...
				$this->add_control(
					'witr_border',
					[
						'label' => esc_html__( 'Active Border', 'softd' ),
						'type' => Controls_Manager::DIMENSIONS,
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Tab Menu Border Active Color', 'softd' ),
						'type' => Controls_Manager::COLOR,
						'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Images option', 'softd' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);		 
				...
				<div class="tab_item">
					<ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
						<?php while ($posts->have_posts()) : $posts->the_post(); 		 	
						  $em_tab_menu  = get_post_meta( get_the_ID(),'_softd_em_tab_menu', true );
						  $em_tab_active  = get_post_meta( get_the_ID(),'_softd_em_tab_active', true );
						  $em_tab_image  = get_post_meta( get_the_ID(),'_softd_em_tab_image', true );
						  ?>	
						  <li class="nav-item">
					...
					<div class="tab-content" id="pills-tabContent">
						  ...
						  <?php while ($posts->have_posts()) : $posts->the_post(); 		 ?>	
							...
							<?php 
							$em_tab_active  = get_post_meta( get_the_ID(),'_softd_em_tab_active', true );
							$em_tab_btn1  = get_post_meta( get_the_ID(),'_softd_em_tab_btn1', true );
							$em_tab_btn1utl  = get_post_meta( get_the_ID(),'_softd_em_tab_btn1utl', true );
							$em_tab_btn2  = get_post_meta( get_the_ID(),'_softd_em_tab_btn2', true );
							$em_tab_btn2url  = get_post_meta( get_the_ID(),'_softd_em_tab_btn2url', true );
							?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Witr_Elementor_Widget_Posttab() );
